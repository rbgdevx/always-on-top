...
#
# What it does:
#   1. Bumps the trailing version segment in AlwaysOnTop.toc
...
DEST="/Applications/World of Warcraft/_retail_/Interface/AddOns/AlwaysOnTop"
